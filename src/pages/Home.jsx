...
export default function Home() {
    return (
        <div>
            <div className="text-white text-center" style={{ backgroundImage: `url(${bg})`, backgroundSize: 'cover', backgroundPosition: 'center', height: '90vh', position: 'relative' }}>
                <h1 className="p-4 py-16 text-6xl">Lorem Ipsum</h1>
                <p className="text-xl p-4 lg:px-52">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse elementum tincidunt laoreet. Donec vitae varius elit, et interdum ligula. Maecenas vulputate dapibus odio, quis pharetra erat faucibus non. Cras placerat ullamcorper metus ac vulputate</p>
